...
namespace FtJohn.Raft.Peers
{
    ...
    {
        const int MAX_COMMAND_LENGTH = 25;
        ...
        public static byte[] DefaultPrefixBytes
        {
            get
            {
                var prefix = Convert.ToInt32("0xABABABAB", 16);
        ...
        public static byte[] DefaultSuffixBytes
        {
            get
            {
                var suffix = Convert.ToInt32("0xCDCDCDCD", 16);
        ...
        public static P2pCommand CreateCommand(string commandName, IMessage payload)
        {
        ...
        public static P2pCommand ConvertBytesToMessage(byte[] bytes)
        {
            ...
            Array.Copy(bytes, 4, commandBytes, 0, MAX_COMMAND_LENGTH);
            Array.Copy(bytes, MAX_COMMAND_LENGTH + 4, sizeBytes, 0, 4);
            ...
            Array.Copy(bytes, MAX_COMMAND_LENGTH + 8, payloadBytes, 0, size);
            Array.Copy(bytes, MAX_COMMAND_LENGTH + 8 + size, checksumBytes, 0, 4);
